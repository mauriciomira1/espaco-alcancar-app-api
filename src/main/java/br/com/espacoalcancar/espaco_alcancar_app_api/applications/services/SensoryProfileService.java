...
public class SensoryProfileService {
    ...
    private void checkUserAuthorization(List<SensoryProfileEntity> response, UUID userId) {
        response.forEach(child -> {
            ...
            if (!child.getChild().getUser().getId().equals(userId)) {
                throw new UnauthorizedHandlerException("User is not authorized to access this resource");
            }
        });
    }
    ...
    public Map<String, Integer> calculateSensoryProfile(ResultsRequestDTO request,
        ...
        if (sensoryProfileType == SensoryProfileType.UNTIL_THREE_YEARS) {
            Integer exploracao = valuesToCalc.get(17) + valuesToCalc.get(18) + valuesToCalc.get(19)
                    + valuesToCalc.get(31)
            ...
            Integer sensibilidade = valuesToCalc.get(0) + valuesToCalc.get(1) + valuesToCalc.get(12)
                    + valuesToCalc.get(15)
            ...
            Integer observacao = valuesToCalc.get(8) + valuesToCalc.get(10) + valuesToCalc.get(11)
                    + valuesToCalc.get(13)
            ...
            Integer movimentos = valuesToCalc.get(35) + valuesToCalc.get(36) + valuesToCalc.get(37)
                    + valuesToCalc.get(38)
            ...
            Integer comportamental = valuesToCalc.get(48) + valuesToCalc.get(49) + valuesToCalc.get(50)
                    + valuesToCalc.get(51)
            ...
            Integer exploracao = valuesToCalc.get(13) + valuesToCalc.get(20) + valuesToCalc.get(21)
                    + valuesToCalc.get(24)
                    + valuesToCalc.get(26)
            ...
            Integer sensibilidade = valuesToCalc.get(2) + valuesToCalc.get(3) + valuesToCalc.get(5)
                    + valuesToCalc.get(6)
                    + valuesToCalc.get(8)
            ...
            Integer observacao = valuesToCalc.get(7) + valuesToCalc.get(11) + valuesToCalc.get(22)
                    + valuesToCalc.get(23)
                    + valuesToCalc.get(25)
            ...
            Integer movimentos = valuesToCalc.get(26) + valuesToCalc.get(27) + valuesToCalc.get(28)
                    + valuesToCalc.get(29)
                    + valuesToCalc.get(30)
                    + valuesToCalc.get(31) +
                    valuesToCalc.get(32) + valuesToCalc.get(33);
            Integer posicaoDoCorpo = valuesToCalc.get(34) + valuesToCalc.get(35) + valuesToCalc.get(36)
                    + valuesToCalc.get(37)
                    + valuesToCalc.get(38)
                    + valuesToCalc.get(39) +
            ...
            Integer socioemocional = valuesToCalc.get(61) + valuesToCalc.get(62) + valuesToCalc.get(63)
                    + valuesToCalc.get(64)
                    + valuesToCalc.get(65)
    ...
    public List<String> getQuestions(SensoryProfileTypeRequestDTO sensoryProfileTypeRequest) {
        ...
        if (sensoryProfileType == SensoryProfileType.UNTIL_THREE_YEARS) {
            ...
            questionsList.add("4. Leva mais tempo do que crianças da mesma idade para responder a perguntas ou ações.");
            ...
            questionsList.add("23. Incomoda-se com luzes brilhantes mais do que outras crianças da mesma idade.");
            ...
            questionsList.add("36. Gosta de atividade física (por exemplo, pular, ser erguido(a) bem alto).");
            questionsList
            ...
            questionsList.add("48. Apresenta dificuldade na transição do leite materno para a alimentação sólida.");
            ...
            questionsList.add("54. Fica tão incomodado(a) em novos ambientes que se torna difícil de acalmá-lo(a).");
            ...
            questionsList.add("3. Tem dificuldade em concluir tarefas quando há música tocando ou a TV está ligada.");
            questionsList.add("4. Se distrai quando há muito barulho ao redor.");
            questionsList.add("5. Torna-se improdutivo(a) com ruídos de fundo (por exemplo, ventilador, geladeira).");
            ...
            questionsList.add("13. Se incomoda mais com luzes brilhantes do que outras crianças da mesma idade.");
            ...
            questionsList.add("33. Perde o equilíbrio inesperadamente ao caminhar sobre uma superfície irregular.");
            ...
            questionsList.add("39. Se segura a objetos, paredes ou corrimões mais do que crianças da mesma idade.");
            ...
            questionsList.add("47. É exigente para comer, principalmente com relação às texturas de alimentos.");
            ...
            questionsList.add("62. Parece ter baixa autoestima (por exemplo, dificuldade de gostar de si mesmo(a)).");
            ...
            questionsList.add("68. Tem fortes explosões emocionais quando não consegue concluir uma tarefa.");
            questionsList.add("69. Tem dificuldade de interpretar linguagem corporal ou expressões faciais.");
