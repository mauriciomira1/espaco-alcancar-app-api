...
public class SensoryProfileService {
  ...
  public List<String> getQuestions(SensoryProfileType sensoryProfileType) {
    ...
    if (sensoryProfileType == SensoryProfileType.UNTIL_THREE_YEARS) {
      ...
      questionsList.add("37. Gosta de atividades rítmicas (por exemplo, balançar, ser embalado, passeios de carro).");
      questionsList.add("38. Se arrisca ao se movimentar ou escalar.");
      questionsList.add("39. Incomoda-se quando colocado(a) de barriga para cima (por exemplo, para ser trocado(a)).");
      ...
      questionsList.add("42. Mostra uma aversão evidente à maioria dos alimentos, com exceção de algumas opções.");
      ...
      questionsList.add("7. Parece não ouvir quando eu o(a) chamo por seu nome (mesmo com sua audição sendo normal).");
      ...
      questionsList.add("19. Fica ansioso(a) quando fica de pé em proximidade a outros (por exemplo, em uma fila)");
